...
instructor: ["Ben Companjen", "Sreenithya Avadakkam", "Agustin Medina", "Pascal Flohr", "Helena Wedig"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Katia Roque", "Sarah Ann Stock", "Claudia Hernandez Esponda", "Elviss Dvinskis"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
